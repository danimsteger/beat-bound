...
//     return <p>Error: {artistError?.message || eventsError?.message}</p>;
    ...
    <div>
      ...
      {/* <section>
        ...
        <div>
          ...
          {Auth.loggedIn() && (
            <button onClick={() => handleAddArtist(artist)}>
              Add to My Page
            </button>
          )}
        </div>
          ...
          {artist?.relatedArtists?.length > 0 ? (
            artist.relatedArtists.map((relatedArtist, index) => (
              <div key={index}>
                ...
                <img
                  src={
                    relatedArtist.imageUrl || "https://via.placeholder.com/150"
                  }
